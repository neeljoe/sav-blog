  ...
  return (
    <div className='flex flex-col gap-8 mt-12 '>
      ...
      <div className='flex gap-8'>
        ...
        <p className='text-xl'>Meghamalai, translating to "Mountain of Clouds," is a hidden gem tucked away in the Western Ghats of 
      ...
      <div className='flex flex-col lg:flex-row gap-8'>
       ...
       {/* menu */}
       <div className='pr-10 h-max sticky top-8'>
